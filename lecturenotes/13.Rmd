...
- Method 3: hypothesis (brms, Savage-Dickey ratio)--somewhat faster, but limited to point null hypotheses, or when a region of practical equivalence is defined in the null model,^[See: https://michael-franke.github.io/intro-data-analysis/ch-03-05-Bayesian-testing-comparison.html] plus the null model must be a proper subset of the full model
