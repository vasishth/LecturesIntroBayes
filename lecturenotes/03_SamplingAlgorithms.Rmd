...
\begin{equation}
f(y\mid x)=  \frac{f(x,y)}{f(x)}= \frac{(2x + 3y + 2)}{4x+10}
\end{equation}
...
To do this, for $f(x\mid y)$, we have  to find $z_1$:
...
\begin{equation}
u = \int_0^{z_2} \frac{(2x + 3y + 2)}{4x+10} \, dy
\end{equation}
...
# Hamiltonian Monte Carlo {#hmc}
  ...
  - HMC will almost always succeed for these complex models.
...
Imagine an ice puck moving over a frictionless surface of varying heights.
  ...
  - The puck moves at constant velocity (momentum) k on a flat surface
